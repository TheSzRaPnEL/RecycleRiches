...
:: Android packaging
set AND_CERT_NAME="RecycleRiches"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\RecycleRiches.p12
...
set IOS_PROVISION=cert\RecycleRiches.mobileprovision
...
set APP_ID=air.RecycleRiches

:: Output packages
set DIST_PATH=dist
set DIST_NAME=RecycleRiches
